...
float cible[]={48.360913, -4.566985};
...
// liste points GPS
float wp_lat[] = {48.428198};
float wp_lon[] = {-4.608139};
...
void loop() {
  int a = 16;    // 16 -> valeur par défault qui marche, sinon ->  map(analogRead(A14),0,1024,0,90);
  int pos1 = 90 - a;
  int pos3 = 90 + a;
  ...
  if (pos >= 0 && pos <= 180){  // commande barre radio commandé
     barre.write(pos);
  }
  ...
  if (ch5 < 1500){   // switch -> 1) radio commandé / 2) semi autonome     
    ...
    */
    ...
    if (ch6 <= 1100){   // le switch 'C' est en pos1 -> mode auto
      /////////////////////////////////////
      //        Mode full auto           //
      /////////////////////////////////////
